  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger">
        <h5 class="modal-title white" id="myModalLabel120">{{trans('buttons.delete') .' '. $full_name ?? '' }}?</h5>
      </div>
      <div class="modal-body">You won't be able to revert this!</div>
      <div class="modal-footer">
          {{ Form::model($teacher, ['method' => 'DELETE', 'route' => ['teachers.destroy', $id], 'id' => 'delete_member_form', 'name' => 'delete_member_form']) }}
